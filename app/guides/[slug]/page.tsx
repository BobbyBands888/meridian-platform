...
export async function generateMetadata({ params }: PageProps<"/guides/[slug]">): Promise<Metadata> {
  ...
  return {
    title: { absolute: `${guide.seoTitle} · ${site.name}` },
      ...
      <Container className="py-10 sm:py-14">
        ...
        <article className="mx-auto mt-6 max-w-2xl">
          ...
          <p role="note" className="mt-8 rounded-xl border border-line bg-surface px-4 py-3 text-[15px] leading-relaxed">
            General information, not legal, financial, or pricing advice. Nashville Buys is not a broker and does not facilitate
            closings. Talk with a Tennessee real estate attorney about your situation.
          </p>
