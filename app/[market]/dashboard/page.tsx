...
export default async function DashboardPage({ params, searchParams }: PageProps<"/[market]/dashboard">) {
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        <section aria-labelledby="details-heading" className="rounded-2xl border border-line p-6 lg:col-span-1">
          ...
          <dl className="mt-4 space-y-3 text-[15px]">
            ...
            <div>
              <dt className="text-muted">Using {brandName(market)} as</dt>
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-xl bg-surface p-5">
              ...
              <p className="mt-1 text-[15px] leading-relaxed text-muted">
                {profile.roles.includes("vendor")
                  ...
                  : live
                    ? `Join the vendor directory. Free for founding vendors. ${VENDOR_CATEGORY_LIMIT_NOTE}`
                    : `Pre-register for the ${brandName(market)} directory. Free for founding vendors. ${VENDOR_CATEGORY_LIMIT_NOTE}`}
              </p>
            ...
            {live && (
              <div className="rounded-xl bg-surface p-5">
                ...
                <p className="mt-1 text-[15px] leading-relaxed text-muted">Browse {market.name} homes listed by their owners.</p>
