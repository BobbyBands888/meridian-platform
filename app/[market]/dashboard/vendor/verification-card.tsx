...
export function VerificationCard({ userId, brand, categoryLabel, licenseRequired, submission, submittedLabel, badgeText }: Props) {
    ...
    <section id="verification" aria-labelledby="verification-heading" className="scroll-mt-24 rounded-2xl border border-line p-6">
      ...
      {verified && badgeText ? (
        ...
        <p className="mt-2 text-[15px] leading-relaxed text-muted">
          ...
          profile shows &ldquo;License and insurance documents reviewed by {brand}&rdquo; with the review date, and you&apos;re
          listed first in {categoryLabel}. Your documents stay private; only the {brand} team can see them.
        </p>
      )}
