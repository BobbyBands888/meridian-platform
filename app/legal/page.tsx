...
export const metadata: Metadata = {
  ...
  description:
    "Nashville Buys terms of service, privacy policy, and fair housing policy. We are a marketplace connector, not a broker, and do not hold funds or facilitate closings.",
  alternates: { canonical: "/legal" },
};

const terms = [
  {
    title: "What Nashville Buys is.",
    body: "Nashville Buys, operated by Ownvista, is an online marketplace that lets home sellers publish listings, lets buyers view them, and lets independent professionals list their services. We connect people. We do not participate in transactions.",
  },
  {
  ...
  },
  {
    ...
    body: "You are responsible for your own transaction. Buyers and sellers should hire their own real estate attorney, home inspector, title company, and lender. Sellers are responsible for complying with all disclosure laws, including Tennessee's Residential Property Condition Disclosure requirements. Vendors are responsible for their own licensing, insurance, client agreements, and legal compliance.",
  },
  {
    title: "Accuracy.",
  ...
  },
  {
    ...
    body: "To the fullest extent permitted by law, Ownvista is not liable for any loss, damage, or dispute arising from any transaction, communication, or relationship between users, or from any vendor's services. Use of this site is at your own risk.",
  },
  {
    title: "Changes.",
...
export default function LegalPage() {
  return (
    <>
      <PageHeader title="Legal" intro="Terms of Service, Privacy Policy, and Fair Housing Policy for Nashville Buys.">
      ...
      <Container>
        <div className="max-w-3xl space-y-16 text-[17px] leading-[1.75]">
          ...
          <section id="fair-housing" aria-labelledby="fair-housing-heading" className="scroll-mt-24">
            ...
            <p className="mt-6">
              Nashville Buys complies with the federal Fair Housing Act and Tennessee law. Listings, vendor profiles, and
              ...
              common prohibited phrases. Any user who discriminates will be removed. To report a concern, email <Mail />.
            </p>
          </section>
        </div>
      </Container>
