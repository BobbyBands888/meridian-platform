---
title: "Tennessee's property disclosure form: what FSBO sellers need to know"
seoTitle: Tennessee Residential Property Condition Disclosure for FSBO Sellers
description: What Tennessee's Residential Property Condition Disclosure is, when sellers provide it, common exemptions, extra required disclosures like sinkholes, and how to fill it out carefully.
publishedAt: 2026-09-15
vendorCategories: [home_inspector, attorney, handyman]
topic: disclosure
---
...
The Tennessee Real Estate Commission publishes the official forms. You can find them through the [Commission's forms page](https://www.tn.gov/commerce/regboards/trec/license/forms.html), and your closing attorney can also provide current versions.
...
- **Consider a pre-listing inspection.** A [home inspector](/vendors/home-inspectors) can help you understand issues you might not know about, and some sellers fix problems first with help from a [handyman](/vendors/handymen).
- **Keep a signed copy** with the date the buyer received it.
- **Have an attorney review it** if anything about the home is unusual, such as past water problems, unpermitted work, or a boundary question. You can find one in our [attorney directory](/vendors/attorneys).

## Next steps

Once your disclosure is ready, you're in a much stronger position to list. Our guide on [how to sell your house without a realtor in Tennessee](/guides/how-to-sell-your-house-without-a-realtor-in-tennessee) covers the rest of the process, and the [pre-sale checklist](/sell/checklist) helps you keep track.
